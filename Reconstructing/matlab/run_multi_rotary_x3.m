function run_multi_rotary_x3(target, CPUorGPU, start, stop)
...
folder_name = sprintf('531_multi_rotary/PSNR_531_multi_rotary_%s_%s', target, CPUorGPU);
save_name = '531_multi_rotary';
