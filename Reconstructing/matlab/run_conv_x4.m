function run_conv_x4(target, CPUorGPU, start, stop)
...
base_weights = sprintf('%s/x4/model_955_x4/955_conv_x4_iter_', model_dir);
model = '../conv/SRCNN_deploy_955.prototxt';
save_name = '955_conv_x4';
folder_name = sprintf('x4/PSNR_955_conv_%s_%s', target, CPUorGPU);
