function run_multi_flip_x4(target, CPUorGPU, start, stop)
...
base_weights = sprintf('%s/model_331_multi_x4/331_multi_x4_iter_', model_dir);
model = '../prop/x4/SRCNN_deploy_331_multi_x4.prototxt';
folder_name = sprintf('331_multi_flip/PSNR_331_multi_flip_%s_%s', target, CPUorGPU);
save_name = '331_multi_flip';
...
for iter = start:100000:stop
    ...
    for data = 1:length(imgFileNameList)
        ...
        im_l_90 = rot90(im_l_y, 1);
        im_l_180 = rot90(im_l_y, 2);
        im_l_270 = rot90(im_l_y, 3);
        
        im_l_flip = flip(im_l_y);
        im_l_90_flip = flip(im_l_90);
        im_l_180_flip = flip(im_l_180);
        im_l_270_flip = flip(im_l_270);
        
        im_h = multi_x4(net, im_l_y);
        im_h_90 = multi_x4(net, im_l_90);
        im_h_180 = multi_x4(net, im_l_180);
        im_h_270 = multi_x4(net, im_l_270);
        
        im_h_flip = multi_x4(net, im_l_flip);
        im_h_90_flip = multi_x4(net, im_l_90_flip);
        im_h_180_flip = multi_x4(net, im_l_180_flip);
        im_h_270_flip = multi_x4(net, im_l_270_flip);
        
        im_h_ave = im_h + rot90(im_h_90,3) + rot90(im_h_180,2) + rot90(im_h_270,1)...
            + flip(im_h_flip) + rot90(flip(im_h_90_flip),3) + rot90(flip(im_h_180_flip),2) + rot90(flip(im_h_270_flip),1);
        im_h_y = im_h_ave.*0.125;
