function run_multi_rotary_x4(target, CPUorGPU, start, stop)
...
folder_name = sprintf('331_multi_rotary/PSNR_331_multi_rotary_%s_%s', target, CPUorGPU);
save_name = '331_multi_rotary';
