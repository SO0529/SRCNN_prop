function run_multi_rotary_x2(target, CPUorGPU, start, stop)
...
folder_name = sprintf('553_multi_rotary/PSNR_553_multi_rotary_%s_%s', target, CPUorGPU);
save_name = '553_multi_rotary';
