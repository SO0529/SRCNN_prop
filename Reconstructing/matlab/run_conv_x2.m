function run_conv_x2(target, CPUorGPU, start, stop)
...
base_weights = sprintf('%s/x2/model_955_x2/955_conv_x2_iter_', model_dir);
model = '../conv/SRCNN_deploy_955.prototxt';
save_name = '955_conv_x2';
folder_name = sprintf('x2/PSNR_955_conv_%s_%s', target, CPUorGPU);
