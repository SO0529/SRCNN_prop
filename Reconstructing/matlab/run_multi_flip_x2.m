function run_multi_flip_x2(target, CPUorGPU, start, stop)
...
model = '../prop/x2/SRCNN_deploy_553_multi_x2.prototxt';
folder_name = sprintf('553_multi_flip/PSNR_553_multi_flip_%s_%s', target, CPUorGPU);
save_name = '553_multi_flip';
...
for iter = start:100000:stop
    ...
    for data = 1:length(imgFileNameList)
        ...
        im_h = multi_x2(net, im_l_y);
        im_h_90 = multi_x2(net, im_l_90);
        im_h_180 = multi_x2(net, im_l_180);
        im_h_270 = multi_x2(net, im_l_270);
        
        im_h_flip = multi_x2(net, im_l_flip);
        im_h_90_flip = multi_x2(net, im_l_90_flip);
        im_h_180_flip = multi_x2(net, im_l_180_flip);
        im_h_270_flip = multi_x2(net, im_l_270_flip);
